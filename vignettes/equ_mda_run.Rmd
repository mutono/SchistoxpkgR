...
# contact_rate = 0.1
max_fec_contact_rate_product = 1/20
max_fecundity = 20
...
predis_aggregation = 0.2 # 0.24 for high prev settings; 0.04 for low prev settings # From "The design of schistosomiasis monitoring and evaluation programmes:
