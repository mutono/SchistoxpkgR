...
```
Once we have defined the parameters, we can create the population and begin running simulations:
...
We can then investigate the use of MDA's in reducing the prevalence of schistosomiasis in the population:
```{r mda, fig.dim = c(8, 6)}
...
legend('topright',legend=c("SAC prev", "SAC heavy burden", 'missed MDA window', 'heavy burden goal'),
       col=c(rgb(110/255, 99/255, 252/255), rgb(30/255, 190/255, 160/255),'black', rgb(2/255, 163/255, 217/255)), lwd = c(2,2,2, 2), lty = c(1,1,2,2), cex=1.2,
       title="", text.font=18, bg='lightblue', bty = 'n')
